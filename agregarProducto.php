    ...
    <div class="col-8 " style="padding-top:30px;">
        ...
        <form action="alta_producto_sql.php" method="post">
            ...
            <div class="mb-3">
                ...
                <input class="input" type="text" name="price" id="price" placeholder="Precio">
            </div>

            <div>
                <div> <textarea for="description" name="description" placeholder="Descripcion"></textarea></div>
            </div>


            <br>
            <select class="input" name="category" require>
